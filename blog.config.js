...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '神秘', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '即刻起航|探索世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xm66.eu.org', // 网站地址
